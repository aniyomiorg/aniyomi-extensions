package eu.kanade.tachiyomi.animeextension.en.allmoviesforyou
...
class AllMoviesForYou : ConfigurableAnimeSource, ParsedAnimeHttpSource() {

    override val name = "AllMoviesForYou(TV Shows)"
    ...
    override fun episodeListSelector() = "table tbody tr"

    override fun episodeFromElement(element: Element): SEpisode {
        val episode = SEpisode.create()
        episode.setUrlWithoutDomain(element.select("td.MvTbPly > a.ClA").attr("abs:href"))
        episode.name = element.select("td span.Num").text() + " : " + element.select("td.MvTbTtl > a").text()
